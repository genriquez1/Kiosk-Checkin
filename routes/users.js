...
router.post('/register', function(req, res){
	...
	if(errors){
          ...
          escortname: escortname
			...
			res.redirect('/kiosk/register');
    }

});


// attempt to make admin registration work
...
router.post('/admin', function(req, res){
	...
	req.checkBody('telephone', 'email is required').notEmpty();
	req.checkBody('company', 'password is required').notEmpty();
	req.checkBody('escortname', 'password confirmation name is required').notEmpty();
...
router.post('/login',
  passport.authenticate('local',{successRedirect:'/', failureRedirect:'/kiosk/login',failureFlash: true}),
  function(req, res) {
		res.	redirect('/');
});
